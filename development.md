...
The backend uses the same port that would be used by its local development server: `http://localhost:8000`.

To stop the `backend` Docker Compose service and run it locally instead:
